...
board[0, 0] = Rook(False, (0, 0), 3)
board[1, 0] = Knight(False, (100, 0), 1)
board[2, 0] = Bishop(False, (200, 0), 2)
board[3, 0] = Queen(False, (300, 0), 4)
board[4, 0] = King(False, (400, 0), 5)
board[5, 0] = Bishop(False, (500, 0), 2)
board[6, 0] = Knight(False, (600, 0), 1)
board[7, 0] = Rook(False, (700, 0), 3)
board[0, 1] = Pawn(False, (0, 100), 0)
board[1, 1] = Pawn(False, (100, 100), 0)
board[2, 1] = Pawn(False, (200, 100), 0)
board[3, 1] = Pawn(False, (300, 100), 0)
board[4, 1] = Pawn(False, (400, 100), 0)
board[5, 1] = Pawn(False, (500, 100), 0)
board[6, 1] = Pawn(False, (600, 100), 0)
board[7, 1] = Pawn(False, (700, 100), 0)
selected_piece = None
possible_moves = []
